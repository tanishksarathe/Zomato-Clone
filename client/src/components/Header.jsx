      ...
      <div className="bg-(--color-surface) flex justify-between items-center px-4 py-2">
        <div>
          <Link to={"/"} className="flex gap-2 justify-center items-center">
            ...
            <span className="font-bold text-2xl text-(--color-text-primary) hover:text-(--color-primary-hover)">
              GrabMyMeal
            </span>
          </Link>
        </div>
          ...
          {isLogin ? (
            <div className="flex justify-center gap-5 items-center">
              <div
                ...
                className="text-(--color-primary) hover:text-(--color-primary-hover) cursor-pointer"
              >
                {user.fullname}
              </div>
              <button
            ...
            <>
              <button
                ...
                className="font-semibold text-(--color-primary) px-4 rounded-lg py-2"
              >
                Login
              </button>
              <button
